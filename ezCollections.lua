...
function addon:OnInitialize()
    ...
    do
        ...
        CreateFrame("Button", "ForgedWoWButton", MainMenuBarArtFrame, "MainMenuBarMicroButton");
        LoadMicroButtonTextures(CollectionsMicroButton, "Help");
        LoadMicroButtonTextures(ForgedWoWButton, "Help");
        ...
        local microButtonNames =
        {
            ...
            [ForgedWoWButton] = TALENTS_BUTTON,
        ...
        microButtonIcons =
        {
            [1] = [[Interface\AddOns\ForgedWoW\UI\Buttons\UI-MicroButton-Mounts]],
            [5] = [[Interface\AddOns\ForgedWoW\UI\UI-MicroButton-Collections]],
            [6] = [[Interface\AddOns\ForgedWoW\UI\UI-MicroButton-Transmogrify]],
        };
        ...
        local function GetMicroButtonTexture(button)
            if button == CharacterMicroButton then
                return [[Interface\AddOns\ForgedWoW\UI\UI-MicroButton-Character]];
            elseif button == PVPMicroButton then
                return [[Interface\AddOns\ForgedWoW\UI\UI-MicroButton-PVP-]]..(UnitFactionGroup("player") or "FFA");
            else
        ...
        setupCollectionsMicroButton = function()
            ...
            LoadMicroButtonTextures(ForgedWoWButton, "Help");
            ForgedWoWButton:SetNormalTexture(CONSTANTS.UI.NORMAL_TEXTURE_BTN)
            ForgedWoWButton:SetPushedTexture(CONSTANTS.UI.PUSHED_TEXTURE_BTN)
            ForgedWoWButton.tooltipText = MicroButtonTooltipText("Forge Talents", "TOGGLEFORGETALENETS");
            ForgedWoWButton.newbieText = "View your Character, Priestige, Race and Forged Skill talents";
            ForgedWoWButton:SetFrameLevel(1000);
            LoadMicroButtonTextures(CollectionsMicroButton, "Help");
        ...
        ForgedWoWButton:SetScript("OnClick", function ()
            ToggleMainWindow();
        end );
    ...
    local function integrationActionButtonAddonName(name)
                    ...
                    alerts =
                    {
                        ...
                        args =
                        {
                            ...
                            color =
                            {
                                ...
                                order = 101,
                                handler = colorHandler, values = "values", get = "get", set = "set", disabled = "disabled",
                            ...
                            customColor =
                            {
                                ...
                                width = "half",
                                order = 102,
                                handler = customColorHandler, get = "get", set = "set", disabled = "disabled",
                                arg = ezCollections.Config.Alerts.AddSkin,
                            },
                            fullRowColor =
                            {
                    ...
                    tooltipSets =
                    {
                        ...
                        args =
                        {
                            ...
                            color =
                            {
                                ...
                                order = 1000,
                                handler = colorHandler, values = "values", get = "get", set = "set",
                            ...
                            customColor =
                            {
                                ...
                                width = "half",
                                order = 1001,
                                handler = customColorHandler, get = "get", set = "set", disabled = "disabled2",
                                arg = ezCollections.Config.TooltipSets,
                            },
                            separator =
                            {
                        ...
                        args =
                        {
                            ...
                            addons =
                            {
                                ...
                                args =
                                {
                                    ...
                                    {
                                        type = "toggle",
                                        name = integrationActionButtonAddonName("Bartender4"),
                                        width = "full",
                                        order = 100,
                                    ...
                                    {
                                        type = "toggle",
                                        name = integrationActionButtonAddonName("ButtonForge"),
                                        width = "full",
                                        order = 200,
                                    ...
                                    {
                                        type = "toggle",
                                        name = integrationActionButtonAddonName("Dominos"),
                                        width = "full",
                                        order = 300,
                                    ...
                                    {
                                        type = "toggle",
                                        name = integrationActionButtonAddonName("KActionBars"),
                                        width = "full",
                                        order = 400,
                                    ...
                                    {
                                        type = "toggle",
                                        name = integrationActionButtonAddonName("LibActionButton (ElvUI)"),
                                        width = "full",
                                        order = 500,
            ...
            itemButtons =
            {
                ...
                args =
                {
                    IconOverlays =
                    {
                        ...
                        order = 100,
                        validate = function()
                            ezCollections.IconOverlays:SetOptionsDirty();
                            ezCollections.IconOverlays:Update(nil, true); -- Automatic defer will take care of delaying it until the config value is set
                            return true;
                        end,
                        args =
                        {
                            Cosmetic =
                            {
                                ...
                                width = "full",
                                order = 100,
                                get = function(info) return ezCollections.Config.IconOverlays.Cosmetic.Enable; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Cosmetic.Enable = value; end,
                            },
                            Junk =
                            {
                                type = "toggle",
                                ...
                                order = 200,
                                get = function(info) return ezCollections.Config.IconOverlays.Junk.Enable; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Junk.Enable = value; end,
                            },
                            JunkMerchant =
                            {
                                type = "toggle",
                                ...
                                order = 201,
                                disabled = function() return not ezCollections.Config.IconOverlays.Junk.Enable; end,
                                get = function(info) return ezCollections.Config.IconOverlays.Junk.Merchant; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Junk.Merchant = value; end,
                            },
                            Known =
                            {
                                type = "toggle",
                                name = L["Config.Integration.ItemButtons.IconOverlays.Known"],
                                desc = L["Config.Integration.ItemButtons.IconOverlays.Known.Desc"],
                                width = "full",
                                order = 300,
                                get = function(info) return ezCollections.Config.IconOverlays.Known.Enable; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Known.Enable = value; end,
                            },
                            KnownTexture =
                            {
                                type = "select",
                                ...
                                width = "half",
                                order = 301,
                                handler = ezCollections.IconOverlays.TextureOptions, values = "values", get = "get", set = "set", disabled = "disabled",
                                arg = ezCollections.Config.IconOverlays.Known,
                            },
                            KnownStyle =
                            {
                                type = "select",
                                ...
                                width = "half",
                                order = 302,
                                handler = ezCollections.IconOverlays.StyleOptions, values = "values", get = "get", set = "set", disabled = "disabled",
                                arg = ezCollections.Config.IconOverlays.Known,
                            },
                            KnownColor =
                            {
                            ...
                            lb1 = { type = "description", name = "", order = 304.9 },
                            KnownAnchor =
                            {
                                type = "select",
                                ...
                                order = 305,
                                handler = ezCollections.IconOverlays.AnchorOptions, values = "values", get = "get", set = "set", disabled = "disabled",
                                arg = ezCollections.Config.IconOverlays.Known,
                            },
                            KnownOffset =
                            {
                                ...
                                softMax = 10,
                                step = 1,
                                disabled = function() return not ezCollections.Config.IconOverlays.Known.Enable or ezCollections.Config.IconOverlays.Known.Anchor == "CENTER"; end,
                                get = function(info) return ezCollections.Config.IconOverlays.Known.Offset; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Known.Offset = value; end,
                            },
                            KnownSize =
                            {
                                type = "range",
                                ...
                                softMax = 32,
                                step = 1,
                                disabled = function() return not ezCollections.Config.IconOverlays.Known.Enable; end,
                                get = function(info) return ezCollections.Config.IconOverlays.Known.Size; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Known.Size = value; end,
                            },
                            Unknown =
                            {
                                type = "toggle",
                                name = L["Config.Integration.ItemButtons.IconOverlays.Unknown"],
                                desc = L["Config.Integration.ItemButtons.IconOverlays.Unknown.Desc"],
                                width = "full",
                                order = 400,
                                get = function(info) return ezCollections.Config.IconOverlays.Unknown.Enable; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Unknown.Enable = value; end,
                            },
                            UnknownTexture =
                            {
                                type = "select",
                                ...
                                order = 401,
                                handler = ezCollections.IconOverlays.TextureOptions, values = "values", get = "get", set = "set", disabled = "disabled",
                                arg = ezCollections.Config.IconOverlays.Unknown,
                            },
                            UnknownStyle =
                            {
                                type = "select",
                            ...
                            lb2 = { type = "description", name = "", order = 404.9 },
                            UnknownAnchor =
                            {
                                type = "select",
                                name = L["Config.Integration.ItemButtons.IconOverlays.Anchor"],
                            ...
                            UnknownOffset =
                            {
                                ...
                                softMax = 10,
                                step = 1,
                                disabled = function() return not ezCollections.Config.IconOverlays.Unknown.Enable or ezCollections.Config.IconOverlays.Unknown.Anchor == "CENTER"; end,
                                get = function(info) return ezCollections.Config.IconOverlays.Unknown.Offset; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Unknown.Offset = value; end,
                            },
                            UnknownSize =
                            {
                                type = "range",
                                ...
                                softMax = 32,
                                step = 1,
                                disabled = function() return not ezCollections.Config.IconOverlays.Unknown.Enable; end,
                                get = function(info) return ezCollections.Config.IconOverlays.Unknown.Size; end,
                                set = function(info, value) ezCollections.Config.IconOverlays.Unknown.Size = value; end,
                            },
                            Addons =
                            {
                                type = "group",
                                ...
                                args = (function()
                                    ...
                                    local function MakeReloadUIButton()
                                        ...
                                        return
                                        {
                                            ...
                                            desc = L["Config.Integration.ActionButtons.ReloadUI.Desc"],
                                            order = order - 1,
                                            hidden = function() return not reloadUINeeded3; end,
                                            func = function() ReloadUI(); end,
                                        };
                                    end
                                    args._reloadUi1 = MakeReloadUIButton();
                                    for addon in ezCollections:Ordered(ezCollections.IconOverlays:GetAddons(), function(_, _, a, b) return a == "ezCollections" or b ~= "ezCollections" and a < b; end) do
                                        local blizzard = addon == "ezCollections";
                                        args[addon] =
                                        {
                                            type = "toggle",
                                            name = blizzard and L["Config.Integration.ItemButtons.Addons.Blizzard"] or integrationActionButtonAddonName(addon),
                                            width = "full",
                                            order = order,
                                            disabled = function() return not blizzard and not IsAddOnLoaded(addon); end,
                                            get = function(info) return ezCollections.Config.IconOverlays.Addons[addon]; end,
                                            set = function(info, value) ezCollections.Config.IconOverlays.Addons[addon] = value; reloadUINeeded3 = reloadUINeeded3 or not value; end,
                                        };
                                        order = order + 1;
                                    end
                    ...
                    dressUp =
                    {
                        ...
                        args =
                        {
                            ...
                            dressUpDesaturateBackground =
                            {
                                ...
                                set = function(info, value) ezCollections.Config.Wardrobe.DressUpDesaturateBackground = value; if ezCollections.Config.Wardrobe.DressUpClassBackground then SetDressUpBackground(DressUpFrame, nil, select(2, UnitClass("player"))); else SetDressUpBackground(DressUpFrame, select(2, UnitRace("player"))); end end,
                            },
                ...
                args =
                {
                    bindings =
                    {
                        ...
                        args =
                        {
                            ...
                            headerForged = { type = "header", name = L["Binding.Header.Forged"], order = 199 },
...
ezCollections =
{
    ...
    GetDressableFromRecipe = function(self, recipe)
        return self.Cache.RecipeToDressable[recipe];
    end,
    ...
    Search = function(self, type, category, query, slot)
        ...
        if slot and slot ~= 0 and type == LE_TRANSMOG_SEARCH_TYPE_ITEMS then
            ...
            PushForgeMessage(ForgeTopic.SEARCH_XMOG, format("%d;%d;%s;%s;%d,%d,%d", type, search.Token, self:GetSlotByCategory(category), query or "", slot, tonumber(id) or 0, tonumber(enchant) or 0));
        elseif type == LE_TRANSMOG_SEARCH_TYPE_USABLE_SETS then
            search.Params[4] = C_TransmogSets.MakeCacheKey();
            PushForgeMessage(ForgeTopic.SEARCH_XMOG, format("%d;%d;%s;%s;%d", type, search.Token, self:GetSlotByCategory(category), query or "", slot or 0));
        else
            PushForgeMessage(ForgeTopic.SEARCH_XMOG, "%d;%d;%s;%s", type, search.Token, self:GetSlotByCategory(category), query or "");
        end
        return search.Token;
    end,
    EndSearch = function(self, type, token)
        ...
        if search.Token == token and self:IsSearchInProgress(type) then
            PushForgeMessage(ForgeTopic.SEARCH_XMOG, format("%d;%d;CANCEL", type, search.Token));
            search.Token = search.Token + 1;
        end
    end,
    ...
    HasMount = function(self, mountID)
        return self:HasAvailableMount(mountID);
    end,
    ...
    HasPet = function(self, petID)
        return self:HasAvailablePet(petID);
    end,
                    ...
                    if type(item) == "number" and not GetItemInfo(item) then
                        ...
                        C_Timer.After(1, function()
                            if not ezCollections.itemCacheRequested then
                                ...
                                PushForgeMessage(ForgeTopic.LOAD_XMOG, "0");
                            ...
                            if not ezCollections.mountCacheRequestNeeded then
                                ...
                                C_Timer.After(1.1, function()
                                    if not ezCollections.mountCacheRequested then
                                        ...
                                        PushForgeMessage(ForgeTopic.LOAD_MOUNTS, "0");
                ...
                for id, info in pairs(db) do
                    if type(id) == "number" and not GetItemInfo(info[1]) then
                        ...
                        C_Timer.After(1, function()
                            if not ezCollections.itemCacheRequested then
                                ezCollections.itemCacheRequested = true;
                                PushForgeMessage(ForgeTopic.LOAD_TOYS, "0");
                                -- StaticPopup_Show("EZCOLLECTIONS_PRELOADING_ITEM_CACHE");
                            end
                        end);
                        break;
    ...
    GetItemTransmog = function(self, unit, bag, slot)
        ...
        elseif (not cache.Loading or cache.ID ~= id) and GetUnitName(unit) == GetUnitName("player") and self.setEmptyItemTransmogCache then
            ...
            cache.Loaded = false;
            cache.Loading = true;
            PushForgeMessage(ForgeTopic.MISSING_XMOG, request);
        end
    end,
    ...
    GetCVarBitfield = function(self, cvar, index)
        return bit.band(ezCollections.Config.CVar[self:GetCharacterConfigKey()][cvar], bit.lshift(1, index - 1)) ~= 0;
    end,
...
local function LoadItemTransmog(unit, slotStrings)
    ...
    for slotString in slotStrings:gmatch("(.-):") do
        ...
        cache.Flags = flags and flags ~= "" and flags;
        cache.Loaded = true;
        cache.Loading = false;
...
SubscribeToForgeTopic(ForgeTopic.MAX_OUTFITS,
    function(msg)
        local maxOutfits, outfitCostHint = strsplit(";", msg);
        ezCollections.MaxOutfits = tonumber(maxOutfits) or 1;
        ezCollections.OutfitCostHint = outfitCostHint;
    end)

SubscribeToForgeTopic(ForgeTopic.PLAYER_XMOG, function(data)
    local obj = DeserializeMessage(DeserializerDefinitions.PLAYER_XMOG, data);
    for type, id in ipairs(obj) do
        if type == "15" then
...
SubscribeToForgeTopic(ForgeTopic.HOLIDAYS, function(msg)
    local obj = DeserializeMessage(DeserializerDefinitions.HOLIDAYS, msg);
    if obj then
        ezCollections.ActiveHolidays = {}
        for holiday, id in ipairs(obj) do

            if id == 1 then
                ezCollections.ActiveHolidays[tonumber(holiday)] = true;
            else
                ezCollections.ActiveHolidays[tonumber(holiday)] = false;
            end
...
SubscribeToForgeTopic(ForgeTopic.COLLECTION_SETUP_STARTED,
    function(msg)
        table.wipe(ezCollections.ItemNameDescriptions);
    end)

SubscribeToForgeTopic(ForgeTopic.COLLECTION_SETUP_FINISHED, function(msg)

end)

SubscribeToForgeTopic(ForgeTopic.LOAD_XMOG,
    function(msg)
        ezCollections.Cache.All.Loaded = true;
        for itemId, item in pairs(GameItems) do
            ezCollections.Cache.All[itemId] = item;
            ezCollections.Collections.Skins[itemId] = false;

            if item.Slot ~= 0 then
                ezCollections.Cache.Slot[SLOTMAP[item.Slot]].Loaded = true
                table.insert(ezCollections.Cache.Slot[SLOTMAP[item.Slot]], itemId)
            end
        end
        
        ezCollections.Callbacks.SkinListLoaded()
        for idStr in msg:gmatch("(%d+);") do
            local id = tonumber(idStr)

            if id then
                ezCollections.Collections.OwnedItems[id] = true;
                ezCollections.Collections.Skins[id] = true;
            end
        end

        ezCollections.Collections.Skins.Loaded = true;
        ezCollections.Collections.Skins.Enabled = true;
        ezCollections.Collections.OwnedItems.Loaded = true;
        ezCollections.Collections.OwnedItems.Enabled = true
    end)

SubscribeToForgeTopic(ForgeTopic.ADD_XMOG,
    function(msg)
        ...
        if id then
            ezCollections.Collections.OwnedItems[id] = true;
            ezCollections.Collections.Skins[id] = true;
            ezCollections.Callbacks.AddSkin(id);
        end
    end)

SubscribeToForgeTopic(ForgeTopic.LOAD_TOYS, function (msg)
    local obj = DeserializeMessage(DeserializerDefinitions.LOAD_TOYS, msg);

    for _, toy in ipairs(obj) do
        ezCollections.Cache.Toys[toy.ID] = { toy.itemID, toy.flags, toy.expansion, toy.sourceType, toy.sourceText, toy.holiday };
    end
...
SubscribeToForgeTopic(ForgeTopic.GET_XMOG_COST,
    function(msg)
        local moneyCost, tokenCost, key = strsplit("&", msg, 3);
        C_Transmog.ClearSlotFailReasons(key);
        C_Transmog.SetCost(key, tonumber(moneyCost), tonumber(tokenCost));
    end)

SubscribeToForgeTopic(ForgeTopic.APPLY_XMOG,
    function(msg)
        local moneyCost, tokenCost, key = strsplit("&", msg, 3);
...
SubscribeToForgeTopic(ForgeTopic.APPLY_XMOG_ERROR,
    function(msg)
        local entryFailReasons, enchantFailReasons, key = strsplit(";", msg, 3);
        C_Transmog.ClearSlotFailReasons(key);
        if entryFailReasons ~= "" then
            for _, slotReason in ipairs({ strsplit("^", entryFailReasons) }) do
                local slot, reason = strsplit("=", slotReason, 2);
                C_Transmog.SetSlotFailReason(key, tonumber(slot), LE_TRANSMOG_TYPE_APPEARANCE, reason);
            end
        end
    end)
...
function addon:CHAT_MSG_ADDON(event, prefix, message, distribution, sender)
   ...
   --[[
    ...
    Dont Know what this does? Something about sorting.
    match(message, "ITEMNAMEDESCRIPTIONS:", 
    LoadIndexedStringList(ezCollections.ItemNameDescriptions, function(container)
            ...
            if not match(result, "OK:", function(costStrings)
                ...
                if enchantFailReasons ~= "" then
                    for _, slotReason in ipairs({ strsplit(",", enchantFailReasons) }) do
                        local slot, reason = strsplit("=", slotReason, 2);
                        C_Transmog.SetSlotFailReason(key, tonumber(slot), LE_TRANSMOG_TYPE_ILLUSION, reason);
                    end
                end
                ezCollections:RaiseEvent("TRANSMOGRIFY_UPDATE");
            end) then
        ...
        match(data, "OUTFIT:", function(result)
            match(result, "COST:", function(result)
                if not match(result, "OK:", function(result)
                    ...
                    if not WardrobeOutfitSaveFrame.editedOutfitID then
                        WardrobeOutfitSaveFrame:Update(false, false, errorText, tonumber(moneyCost), tonumber(tokenCost), tonumber(failedItemMask), tonumber(failedEnchantMask));
                    end
                end) then
...
function addon:INSPECT_TALENT_READY(event)
    ...
    PushForgeMessage(ForgeTopic.PLAYER_XMOG, target);
end
    ...
    if equipped and ezCollections:IsSkinSource(oGetInventoryItemID("player", slot)) == true then
        if WardrobeFrame_IsAtTransmogrifier() then
            ...
            batchEquipmentRequest = ezCollections.AceAddon:ScheduleTimer(function()
                ...
                PushForgeMessage(ForgeTopic.PLAYER_XMOG, GetUnitName("player"));
            end, 1);
        end
    end
end
...
function addon:UNIT_SPELLCAST_START(event, unit, name, rank, castID)
    if name and unit == "player" and IsOutdoors() then
        if castID == 0 then
            ezCollectionsUpdateActionBars();
            return;
        end
        ...
        if ezCollections.Config.TooltipTransmog.Enable or ezCollections.Config.TooltipFlags.Enable then
            ...
            if ezCollections.Config.TooltipTransmog.Enable then
                ...
                if fakeEntry and fakeEntry ~= 0 or hasPendingUndo then
                    if hasPendingUndo then
                        ...
                        if fakeEntry == ITEM_HIDDEN then
                            ...
                            texture = [[Interface\AddOns\ForgedWoW\UI\PaperDollInfoFrame\UI-GearManager-LeaveItem-Transparent]];
                        end
                        ...
                        if fakeEntry == ITEM_HIDDEN and ezCollections.Config.TooltipTransmog.NewHideVisualIcon then
                            texture = [[Interface\AddOns\ForgedWoW\UI\Transmogrify\Transmogrify]];
                ...
                if fakeEnchant and fakeEnchant ~= 0 or hasPendingIllusionUndo then
                    ...
                    if not texture then
                        texture = [[Interface\AddOns\ForgedWoW\UI\EnchantIcon]]; -- [[Interface\Icons\INV_Scroll_05]]
                    end
