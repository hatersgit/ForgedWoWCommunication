...
WARDROBE_TOOLTIP_CYCLE_ARROW_ICON = [[|TInterface\AddOns\ForgedWoW\UI\Transmogrify\transmog-tooltip-arrow:12:11:-1:-1|t]];
WARDROBE_TOOLTIP_CYCLE_SPACER_ICON = [[|TInterface\AddOns\ForgedWoW\UI\Common\spacer:12:11:-1:-1|t]];
