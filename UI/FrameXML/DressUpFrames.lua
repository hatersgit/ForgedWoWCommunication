...
local TRANSMOGRIFY_TOOLTIP_APPEARANCE_KNOWN_CHECKMARK = [[|TInterface\AddOns\ForgedWoW\UI\Common\CommonIcons:16:16:0:-1:2048:1024:1:257:517:773|t ]]..TRANSMOGRIFY_TOOLTIP_APPEARANCE_KNOWN;
...
function DressUpOutfitDetailsSlotMixin:SetIllusion(transmogID)
	...
	if isHiddenVisual then
		icon = [[Interface\AddOns\ForgedWoW\Collection\Textures\EnchantSlotIcon]];
	end
...
DressUpOutfitDetailsPanelMixin:OnLoad();