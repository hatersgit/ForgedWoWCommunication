...
TalentTreeWindow:SetPoint("CENTER", 0, -320) --- LEFT/RIGHT -- --UP/DOWN --
...
TalentTreeWindow.CloseButton = CreateFrame("Button", TalentTreeWindow.CloseButton, TalentTreeWindow,
    "UIPanelCloseButton")
